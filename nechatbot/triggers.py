...
async def swearing(text: str) -> str:
    is_swearing = words_in_text(constants.trash, text)
    return "а давайте не материться" if is_swearing else ""


async def hate_speech(text: str) -> str:
    is_hate_speech = words_in_text(constants.hate_speech, text)
...
async def random_dog(text: str) -> str:
    ...
    has_random_dog = words_in_text(constants.random_dog, text)
...
async def corgi(text: str) -> str:
    ...
    has_corgi = words_in_text(constants.corgi, text)
...
async def shibe(text: str) -> str:
    ...
    has_shibe = words_in_text(constants.shibe, text)
...
async def toy(text: str) -> str:
    ...
    has_toy = words_in_text(constants.toy, text)
...
async def pug(text: str) -> str:
    ...
    has_pug = words_in_text(constants.pug, text)
...
async def terrier(text: str) -> str:
    ...
    has_terrier = words_in_text(constants.terrier, text)
